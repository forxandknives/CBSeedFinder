...
__device__ inline int32_t TurnIfDeviating(int8_t maxDeviationDistance, int8_t pathx, int8_t center, int8_t dir);
__device__ inline bool TurnIfDeviatingBool(int8_t maxDeviationDistance, int8_t pathx, int8_t center, int8_t dir);
__device__ inline int32_t MoveForward(int8_t dir, int8_t pathx, int8_t pathy, int8_t rv);
